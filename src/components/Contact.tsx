  ...
  return (
    <section id="contact" className="py-24 container-padding relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-4xl font-mono font-bold mb-6 tracking-tighter text-white">
          ESTABLISH_CONNECTION
        </h2>
        
        <p className="text-slate-400 text-lg mb-12 max-w-xl mx-auto font-sans">
        ...
        <div className="flex flex-col items-center gap-10">
          <a 
            ...
            className="group relative px-10 py-5 bg-white text-slate-950 text-xl font-mono font-bold rounded-xl overflow-hidden transition-all hover:scale-105"
          >
          ...
          <div className="flex gap-8">
            {[
              ...
              >
                <div className="p-4 bg-white/5 rounded-xl border border-white/5 group-hover:border-cyan-500/30 transition-colors">
                  {social.icon}
                </div>
