...
export default function Experience() {
  return (
    <section id="experience" className="py-24 container-padding bg-black">
      <motion.div
      ...
      >
        <h2 className="text-3xl font-mono font-bold mb-12 tracking-tight text-white">
          ...
          {experiences.map((exp) => (
            <div key={exp.id} className="relative pl-8 border-l border-cyan-500/30 group">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-2 gap-2">
                ...
                <span className="text-[10px] font-mono font-bold text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 rounded">
                  {exp.period}
                </span>
              </div>
              ...
              <p className="text-slate-400 leading-relaxed max-w-3xl font-sans">
                {exp.description}
              </p>
